...
| [ftlib](ftlib.cmd)              | Windows XP+  | Provides some useful re-usable functions for batch scripts | Many batch scripts share some behaviours                                 |
| [shrinkpath](shrinkpath)        | Windows XP+  | Remove non-existant and shorten path var                   | Becuase a 1024 char path can be a problem                                |
| [bren](bren.cmd)                | Windows 10+  | Add a pre/sufix to a collection of files                   | Adding many web resources to a Power Apps solution can be painful        |
